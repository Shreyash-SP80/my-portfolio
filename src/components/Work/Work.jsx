...
const Work = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-15 md:py-20 bg-gradient-to-br from-gray-100 to-gray-100 dark:from-gray-900 dark:to-gray-900"
      id="work"
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-8 md:mb-20">
          ...
          <div ref={dividerRef} className="w-24 md:w-40 h-1 md:h-1 bg-gradient-to-r from-indigo-500 to-purple-500 mx-auto mb-4 md:mb-6 rounded-full" />
          <p ref={subtitleRef} style={{ fontFamily: "'Source Sans Pro', sans-serif"}} className="text-base md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className={`flex-1 p-4 md:p-6 flex flex-col justify-center ${isMobile ? 'order-2' : ''}`}>
                <span style={{ fontFamily: "'Dancing Script', cursive"}} className="inline-block text-xl md:text-2xl font-bold mb-1 text-gray-900 dark:text-white">
                  0{index + 1}
                </span>
                <h3 style={{ fontFamily: "'Dancing Script', cursive"}} className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-gray-900 dark:text-white">
                  {project.title}
                </h3>
                <p style={{ fontFamily: "'Open Sans', sans-serif" }} className="text-sm md:text-base text-gray-700 dark:text-gray-300 mb-3 md:mb-4 max-w-xl">
                  {project.description}
                </p>
        ...
        >
          ...
          <p style={{ fontFamily: "'Source Sans Pro', sans-serif"}} className="text-base md:text-lg text-gray-600 dark:text-gray-300 mb-4 md:mb-6">
