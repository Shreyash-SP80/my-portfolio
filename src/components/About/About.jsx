...
function About() {
  ...
  // ];
  // const skills = [
  //   { name: "DSA In C++", icon: <SiCplusplus /> },
  //   { name: "C++", icon: <SiCplusplus /> },
  //   { name: "Java", icon: <FaJava /> },

  //   { name: "MERN Stack", icon: <SiReact /> }, // common icon
  //   { name: "PHP", icon: <SiPhp /> },
  //   { name: "MySQL", icon: <SiMysql /> },

  //   { name: "SQL", icon: <FaDatabase /> },
  //   { name: "Python", icon: <SiPython /> },
  //   { name: "Data Science", icon: <FaCode /> }, // common icon

  //   { name: "PowerBI", icon: <FaChartBar /> },
  //   { name: "Tailwind", icon: <SiTailwindcss /> },

  //   { name: "GSAP", icon: <SiGreensock /> },
  //   { name: "Framer Motion", icon: <FaCode /> }, // common
    ...
    >
      ...
      >
        <div className="text-center mb-12 md:mb-20">
          ...
          <p ref={subtitleRef} style={{ fontFamily: "'Source Sans Pro', sans-serif"}} className="text-lg md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
